...
# Route for the admin page with the upload form
@app.route('/admin')
def admin():
    return render_template('admin.html')

# Route to handle file uploads by the admin
...
# Route for the user page to ask questions
@app.route('/user')
def user():
    return render_template('user.html')

# Route to handle queries from users
